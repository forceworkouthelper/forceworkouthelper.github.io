...
Move the scroll wheels to select the desired time cap for a set.

The wheels are arranged in the familiar **hours : minutes : seconds** format.

If set to zeroes, the set duration will be unlimited.
...
Move the scroll wheel to select the desired number of **additional** For Time 
sets.

If the scroll wheel is at 0, you will have exactly one For Time set.
